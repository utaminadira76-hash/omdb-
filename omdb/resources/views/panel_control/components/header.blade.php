<nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg">
            <i class="fas fa-globe"></i> {{ __('messages.select_language') }}</a>
            <div class="dropdown-menu dropdown-menu-right">
              <a href="{{ route('setlocale', 'en') }}" class="dropdown-item">EN</a>
              <a href="{{ route('setlocale', 'id') }}" class="dropdown-item">ID</a>
            </div>
          </li>
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="assets/img/avatar/avatar-1.png" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block">Hi, Nadira</div></a>
            <div class="dropdown-menu dropdown-menu-right">
